...
<section class="booking-page"><div class="site-shell"><div class="confirmation-card">
    ...
    <h1>{{ $appointment->status === 'pending_payment' ? 'Booking received' : 'You are booked!' }}</h1>
    ...
    <div class="confirmation-details">
        ...
        <div><span class="detail-label">Payment</span><span class="detail-value">{{ $appointment->payments->first()?->method === 'cash' ? 'Cash after service' : 'Online payment demo' }}</span></div>
    ...
    @if($appointment->status === 'pending_payment')<div class="demo-note" style="text-align:left;margin-bottom:22px"><i class="ph ph-info"></i><span>This MVP created a demo PayMongo payment record. Connect live credentials and checkout before using online payments in production.</span></div>@endif
